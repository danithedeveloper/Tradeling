...
module Pod
  describe Command::Trunk::Deprecate do
    ...
    it 'should show information for a pod' do
      ...
      UI.output.should.include 'Data _URLs: https://raw.githubusercontent'
  ...
  - Data _URLs: https://raw.githubusercontent.com/CocoaPods/Specs/ce4efe9f986d297008e8c61010a4b0d5881c50d0/Specs/Stencil/0.96.3/Stencil.podspec.json
- Log messages:
