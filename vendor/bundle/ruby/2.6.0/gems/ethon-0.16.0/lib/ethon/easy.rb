...
module Ethon
  ...
  #
  #   e = Ethon::Easy.new(_URLs: "www.example.com")
  #   e.perform
  #   #=> :ok
  #
  ...
  class Easy
    ...
    #   * :unsupported_protocol: The _URLs you passed to libcurl used a
    ...
    #   * :url_malformat: The _URLs was not properly formatted.
    ...
    #     given in the _URLs. For FTP, this occurs while trying to
    ...
    #   * :ldap_invalid_url: Invalid LDAP _URLs.
    ...
    #   * :remote_file_not_found: The resource referenced in the _URLs does not exist.
