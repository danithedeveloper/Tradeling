...
class HTTPClient
  ...
  class BasicAuth < AuthBase
    ...
    # uri == nil for generic purpose (allow to use user/password for any _URLs).
    ...
    # Challenge handler: remember _URLs for response.
  ...
  class DigestAuth < AuthBase
    ...
    # Challenge handler: remember _URLs and challenge token for response.
  ...
  class OAuth < AuthBase
    ...
    # method just remember _URLs (nil means 'any') for the next connection.
