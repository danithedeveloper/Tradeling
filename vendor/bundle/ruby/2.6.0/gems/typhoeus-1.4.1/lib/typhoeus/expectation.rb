module Typhoeus
  ...
  # a _URLs and options, like a request. They are compared
  # to the request _URLs and options in order to evaluate
  ...
  class Expectation
    ...
    # Check whether the base_url matches the request _URLs.
