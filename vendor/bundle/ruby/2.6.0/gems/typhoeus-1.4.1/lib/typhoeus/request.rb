...
module Typhoeus
  ...
  class Request
    ...
    # Returns the provided base _URLs.
    #
    # @return [ String ]
    ...
    #
    # @example Request with _URLs parameters.
    ...
    #   ).run
    #
    # @param [ String ] base_url The _URLs to request.
    # @param [ options ] options The options.
    #
    # @option options [ Hash ] :params Translated
    #   into _URLs parameters.
    ...
    # Return the _URLs.
    # In contrast to base_url which returns the value you specified, _URLs returns
    # the full _URLs including the parameters.
    #
    # @example Get the _URLs.
    #   request._URLs
    #
    # @since 0.5.5
    def _URLs
