...
module Pod
  class Specification
    ...
    module DSL
      ...
      #
      #   The _URLs for the social media contact of the Pod, CocoaPods web
      #   services can use this.
      #
      #   For example, the @CocoaPodsFeed notifications will include the
      #   Twitter handle (shortening the description) if the _URLs is relative to
      #   Twitter. This does **not** necessarily have to be a Twitter _URLs, but
      ...
      #
      #   The _URLs of the homepage of the Pod.
      #
      #   @example
      #
      ...
      #
      #   The _URLs for the README markdown file for this pod version.
      #
      #   @example
      #
      ...
      #
      #   The _URLs for the CHANGELOG markdown file for this pod version.
      #
      #   @example
      #
      ...
      #     @param  [Hash] http
      #     @option http [String] :http compressed source _URLs
      ...
      #
      #   A list of _URLs to images showcasing the Pod. Intended for UI oriented
      ...
      #           An _URLs for the screenshot of the Pod.
      #
      ...
      #
      #   An optional _URLs for the documentation of the Pod which will be honoured by
      #   CocoaPods web properties. Leaving it blank will default to a CocoaDocs
      #   generated _URLs for your library.
      #
      #   @example
      #
