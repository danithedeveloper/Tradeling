  ...
  class Specification
    module DSL
      ...
      module RootAttributesAccessors
        ...
        # @return [String] The social media _URLs.
        #
        ...
        # @return [String] The _URLs of the homepage of the Pod.
        #
        def homepage
        ...
        # @return [Array<String>] The list of the _URLs for the screenshots of
        #         the Pod.
        #
        ...
        # @return [String, Nil] The documentation _URLs of the Pod if specified.
        #
