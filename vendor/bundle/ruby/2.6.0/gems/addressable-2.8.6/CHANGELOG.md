...
- fixes "invalid byte sequence in UTF-8" exception when unencoding _URLs containing non UTF-8 characters ([#459](https://github.com/sporkmonger/addressable/pull/459))
