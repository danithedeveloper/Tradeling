    ...
    describe 'Try' do
      ...
      it 'presents the help if no name is provided' do
        ...
        should.raise CLAide::Help do
          command.validate!
        end.message.should.match(/A Pod name or _URLs is required/)
      end
      ...
      it 'presents the help if name and podspec name is provided' do
        ...
        should.raise CLAide::Help do
          command.validate!
        end.message.should.match(/Podspec name can only be used with a Git _URLs/)
      end
      ...
      it 'allows the user to try the Pod with the given Git _URLs' do
